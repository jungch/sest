...
#' @keywords plot.sexEstimation
#' @export
#' @examples
#' plot.sexEstimation(sex_estimation = sexEst)

plot.sexEstimation <- function(sex_estimation = NULL, samples=NULL, main="", filename=NULL, include_reference=FALSE){
